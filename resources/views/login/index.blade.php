...
<html lang="pt">
  <head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="public/imagens/clinica_logo" />
        ...
        <div class="authentication-inner">
          ...
          <div class="card px-sm-6 px-0">
            <div class="card-body">
              ...
              <p class="mb-6">Inicie sessão para acessar sua conta</p>

              <form method="POST" class="mb-6" action="{{ route('login.process') }}">
                @csrf
                @method('POST')
                <div class="mb-6">
